...
| *Freemium* | 24 Storage VMs insgesamt ^1,2^ 


| *Kapazitätsbasierte PAYGO oder BYOL* ^3^ | 24 Storage VMs insgesamt ^1,2^ 
...
| *Node-basiertes BYOL* ^4^ | 24 Storage VMs insgesamt ^1,2^ 
|===
